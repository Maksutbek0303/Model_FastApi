...
import joblib
from mysite.database.schema import StudentSchema

student_router = APIRouter(prefix='/Student', tags=['Student Api'])

model = joblib.load('mysite/ml_models/stu_model.pkl')
scaler = joblib.load('mysite/ml_models/stu_model.pkl')
